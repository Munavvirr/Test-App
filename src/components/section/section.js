...
const Section = () => {
    ...
    useEffect(() => {
        axios.get('http://munnapp.me-vulcann.com/api/sectors')
            .then(response => {
    ...
    const loadData = () => {
        ...
        if (!hasLoadedData) {
            axios.get('http://munnapp.me-vulcann.com/api/latest-user-data')
                .then(response => {
    ...
    const updateData = () => {
        ...
        axios.put(`http://munnapp.me-vulcann.com/api/update-user-data/${formPayload.userId}`, formPayload, {headers: {
   ...
   const handleSubmit = (event) => {
    ...
    if (validateForm()) {
        ...
        const formPayload = {
            ...
            axios.post('http://munnapp.me-vulcann.com/details/add', formPayload)
                .then(response => {
