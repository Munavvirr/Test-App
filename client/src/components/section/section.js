...
const Section = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:5824/api/sectors')
            .then(response => {
    ...
    const loadData = () => {
        ...
        if (!hasLoadedData) {
            axios.get('http://localhost:5824/api/latest-user-data')
                .then(response => {
    ...
    const updateData = () => {
        ...
        axios.put(`http://localhost:5824/api/update-user-data/${formPayload.userId}`, formPayload, {headers: {
   ...
   const handleSubmit = (event) => {
    ...
    if (validateForm()) {
        ...
        const formPayload = {
            ...
            axios.post('http://localhost:5824/details/add', formPayload)
                .then(response => {
